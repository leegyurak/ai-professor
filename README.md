...
교육 자료 PDF를 업로드하면 AI가 자동으로 핵심 내용을 요약하고 예상 문제를 생성해주는 크로스 플랫폼 애플리케이션 (Web & Desktop)
...
AI Professor는 학생들의 효율적인 학습을 돕기 위해 개발된 크로스 플랫폼 애플리케이션입니다. Claude AI의 강력한 문서 분석 능력을 활용하여 복잡한 교육 자료를 명확하고 체계적인 요약본으로 변환하고, 학습 내용을 점검할 수 있는 예상 문제를 자동으로 생성합니다. 웹 브라우저와 데스크톱 앱 모두에서 사용 가능합니다.
