...
**사용자가 "중요: 다음 부분은 반드시 포함해주세요" 형태로 특정 부분을 명시한 경우, 해당 부분은 반드시 요약에 포함되어야 합니다.**

- 사용자가 지정한 중요 부분은 요약에서 누락되어서는 안 됩니다
- 해당 부분에 대해 충분히 상세하게 다루어야 합니다
- 중요 부분이 여러 개인 경우, 모든 항목을 빠짐없이 포함해야 합니다
- 각 중요 부분에 대한 설명은 원문에 충실하되, 이해하기 쉽게 작성합니다
